...
//    public easy.TreeNode mergeTreesHelper(easy.TreeNode t1, easy.TreeNode t2) {
//        easy.TreeNode newNode;
//
//        if (t1 == null && t2 == null) return null;
//        if (t1 == null) {
//            newNode = new easy.TreeNode(t2.val);
//            newNode.left = mergeTreesHelper(null, t2.left);
//            newNode.right = mergeTreesHelper(null, t2.right);
//        } else if (t2 == null) {
//            newNode = new easy.TreeNode(t1.val);
//            newNode.left = mergeTreesHelper(t1.left, null);
//            newNode.right = mergeTreesHelper(t1.right, null);
//        } else {
//            newNode = new easy.TreeNode(t1.val + t2.val);
